"""
Django settings for innovape project.
...
SECRET_KEY = 'django-insecure-v*i#2y*&k$1xu9^@-shmne97up44+2(uriyh-5alsq!s3favxx'
...
WSGI_APPLICATION = 'innovape.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Redis가 같은 인스턴스에서 실행 중일 때
        'OPTIONS': {
