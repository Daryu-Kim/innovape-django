...
from .views import DashboardHomeView, DashboardProductHome, DashboardOrderHome, DashboardProductAdd, DashboardProductCategory, DashboardProductDisplay, DashboardProductInventory, DashboardProductList, DashboardProductOutofstock, DashboardConsumerHome
