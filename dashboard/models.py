...
class Product(models.Model):
    ...
    product_detail = ArrayField(models.CharField(max_length=50), blank=True, verbose_name='상품 상세페이지')
    ...
    product_thumbnail_name = models.CharField(max_length=50, blank=True, verbose_name='상품 이미지 파일 이름')
